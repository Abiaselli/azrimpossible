...
class AstroSelfAttention(nn.Module):
    def __init__(self, hidden_dim, n_heads):
        ...
        self.trace_to_prob = nn.Linear(1, 1)
        self.trace_to_prob.bias.data.fill_(-3.0)  # initialize with low default dropout
    ...
    def forward(self, x, astro_trace):
        ...
        if self.training:
            ...
            drop_probs = torch.sigmoid(self.trace_to_prob(drop_input))  # [B, S, 1]
